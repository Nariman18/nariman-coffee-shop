          ...
          {testimonials.map((person, index) => {
            return (
              <SwiperSlide key={index} className="w-full h-full">
                <div className="flex justify-center h-full xl:pt-14 sm:pt-20 pt-8">
                  <div className="max-w-[60%] text-primary">
                    <IoMdQuote className="xl:text-6xl sm:text-5xl text-5xl text-primary mb-12 mx-auto" />
                    <p className="md:text-xl sm:text-xl text-xl font-secondary text-center mb-8">
                      {person.message}
                    </p>
